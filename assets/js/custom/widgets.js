...
var KTWidgets = {
    init: function () {
        ...
        !(function () {
            ...
            // (membership_jan = document.getElementById('membership_jan').value),
            // (membership_feb = document.getElementById('membership_feb').value),
            // (membership_mar = document.getElementById('membership_mar').value),
            // (membership_apr = document.getElementById('membership_apr').value),
            // (membership_may = document.getElementById('membership_may').value),
            // (membership_jun = document.getElementById('membership_jun').value),
            // (membership_jul = document.getElementById('membership_jul').value),
            // (membership_aug = document.getElementById('membership_aug').value),
            // (membership_sep = document.getElementById('membership_sep').value),
            // (membership_oct = document.getElementById('membership_oct').value),
            // (membership_nov = document.getElementById('membership_nov').value),
            // (membership_des = document.getElementById('membership_des').value),
            // console.log(document.getElementById('membership_jan').value);
            a &&
                new ApexCharts(a, {
                    series: [
                        { name: "Membership", data:
                            [
                                document.getElementById('membership_jan').value,
                                document.getElementById('membership_feb').value,
                                document.getElementById('membership_mar').value,
                                document.getElementById('membership_apr').value,
                                document.getElementById('membership_may').value,
                                document.getElementById('membership_jun').value,
                                document.getElementById('membership_jul').value,
                                document.getElementById('membership_aug').value,
                                document.getElementById('membership_sep').value,
                                document.getElementById('membership_oct').value,
                                document.getElementById('membership_nov').value,
                                document.getElementById('membership_des').value
                            ]
                        },
                        { name: "Guest", data:
                            [
                                document.getElementById('guest_jan').value,
                                document.getElementById('guest_feb').value,
                                document.getElementById('guest_mar').value,
                                document.getElementById('guest_apr').value,
                                document.getElementById('guest_may').value,
                                document.getElementById('guest_jun').value,
                                document.getElementById('guest_jul').value,
                                document.getElementById('guest_aug').value,
                                document.getElementById('guest_sep').value,
                                document.getElementById('guest_oct').value,
                                document.getElementById('guest_nov').value,
                                document.getElementById('guest_des').value
                            ]
                        },
                    ],
                    chart: {
            ...
            (function () {
                ...
                [].slice.call(t).map(function (t) {
                    (e = parseInt(KTUtil.css(t, "height"))),
                        new ApexCharts(t, {
                            series: [
                                { name: "Transaksi In", data:
                                    [
                                        document.getElementById('transaksi_in_jan').value,
                                        document.getElementById('transaksi_in_feb').value,
                                        document.getElementById('transaksi_in_mar').value,
                                        document.getElementById('transaksi_in_apr').value,
                                        document.getElementById('transaksi_in_may').value,
                                        document.getElementById('transaksi_in_jun').value,
                                        document.getElementById('transaksi_in_jul').value,
                                        document.getElementById('transaksi_in_aug').value,
                                        document.getElementById('transaksi_in_sep').value,
                                        document.getElementById('transaksi_in_oct').value,
                                        document.getElementById('transaksi_in_nov').value,
                                        document.getElementById('transaksi_in_des').value
                                    ]
                                },
                                { name: "Transaksi Out", data:
                                    [
                                        document.getElementById('transaksi_out_jan').value,
                                        document.getElementById('transaksi_out_feb').value,
                                        document.getElementById('transaksi_out_mar').value,
                                        document.getElementById('transaksi_out_apr').value,
                                        document.getElementById('transaksi_out_may').value,
                                        document.getElementById('transaksi_out_jun').value,
                                        document.getElementById('transaksi_out_jul').value,
                                        document.getElementById('transaksi_out_aug').value,
                                        document.getElementById('transaksi_out_sep').value,
                                        document.getElementById('transaksi_out_oct').value,
                                        document.getElementById('transaksi_out_nov').value,
                                        document.getElementById('transaksi_out_des').value
                                    ]
                                },
                            ],
                            chart: {
                            ...
                            yaxis: {
                                min: 0,
                                max: document.getElementById('transaksi_max').value,
                                labels: {
                                    style: { colors: a, fontSize: "12px" },
                                },
                            },
